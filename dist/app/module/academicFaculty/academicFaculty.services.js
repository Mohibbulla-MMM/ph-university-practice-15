...
const createAcademicFaculty = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield academicFaculty_mode_1.AcademicFaculty.create(payload);
    return result;
});
const getAllAcademicFaculty = () => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield academicFaculty_mode_1.AcademicFaculty.find();
    return result;
});
const getSingleAcademicFaculty = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield academicFaculty_mode_1.AcademicFaculty.findById(id);
    return result;
});
const updateAcademicFaculty = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield academicFaculty_mode_1.AcademicFaculty.findByIdAndUpdate(id, payload, {
        new: true,
    });
    return result;
});
